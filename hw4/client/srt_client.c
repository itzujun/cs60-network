  ...
  while(1) {
    if(snp_recvseg(overlay_conn, segPtr) == 1){
      ...
      if(segPtr->header.type == SYNACK){
        ...
        sendBuf_handleACK(segPtr->header.ack_num);
      }
      else{
